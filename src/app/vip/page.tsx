...
function VipContent() {
  ...
  // Active le badge VIP dans le stockage du navigateur dès le paiement validé
  useEffect(() => {
    if (isSuccess) {
    ...
    return (
      <div className="max-w-xl w-full bg-slate-900 border border-emerald-500/40 rounded-3xl p-8 text-center shadow-2xl">
        ...
        <p className="text-slate-300 mb-8">
          Votre accès membre est activé sur cet appareil. Tous les contacts vendeurs et adresses complètes sont désormais déverrouillés.
        </p>
        <a
          href="/deals"
  ...
  return (
    <div className="max-w-4xl mx-auto text-center">
      ...
      <p className="text-lg text-slate-400 mb-12">
        Accédez aux contacts directs des vendeurs, analyses de rendement détaillées et deals exclusifs.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8 text-left">
        ...
        <div className="bg-slate-900 border-2 border-amber-500/80 rounded-2xl p-8 flex flex-col justify-between shadow-2xl relative">
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-300 text-sm mb-8">
              <li className="flex items-center">✓ Tout ce qui est inclus dans Pro</li>
